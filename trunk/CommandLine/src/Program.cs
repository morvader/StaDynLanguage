...
namespace CommandLine {
    static class Program {
        static void Main(string[] args) {
            ...
            ParseArguments(args);
            Tests.Parse.parse(parameters.InputFileNames, parameters.OutputFileName, parameters.TargetPlatform, Application.StartupPath + "\\Tests\\", "ilasm.exe", "TypeTable.txt", parameters.Run);
        }
