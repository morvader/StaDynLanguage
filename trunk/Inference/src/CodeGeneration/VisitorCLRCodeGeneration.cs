...
namespace CodeGeneration {
    ...
    class VisitorCLRCodeGeneration<T> : VisitorILCodeGeneration<T> where T : CLRCodeGenerator {
        ...
        /// <summary>
        /// Invokes a method without knowing its type, using introspection.
        /// Code Generation Template:
        ///  * ld       <implicit object>
        ///  * CallVirt   instance class [mscorlib]System.WriteType [mscorlib]System.Object::GetType()
        ///  * ldstr    <member name>
        ///  * ldc.i4   <number of parameters>
        ///  * newarr     [mscorlib]System.WriteType
        ///  * <for each parameter>
        ///  *   dup
        ///  *   ldc.i4 <index of the parameter>
        ///  *   ldtoken <type> (e.g. [mscorlib]System.Int32)
        ///  *   call class [mscorlib]System.WriteType [mscorlib]System.WriteType::GetTypeFromHandle(valuetype [mscorlib]System.RuntimeTypeHandle)
        ///  *   stelem.ref
        ///  * CallVirt instance class [mscorlib]System.Reflection.MethodInfo [mscorlib]System.WriteType::GetMethod(string,class [mscorlib]System.WriteType[])
        ///  * ld   <implicit object>
        ///  * ldc.i4   <number of parameters>
        ...
        ///  *   dup
        ///  *   ldc.i4 <index of the parameter>
        ///  *   ld     <parameter> (Box is needed for built-in types)
        ///  *   stelem.ref
        ...
        internal void IntrospectiveInvocation(InvocationExpression node, Object obj, Object inheritedAttributes, string memberName) {
            ...
            this.InstrospectiveInvocationLoadType(node.Arguments.ExpressionCount, memberName);
            ...
            this.IntrospectiveInvocationInvokeMethod(node, obj);
            for (int i = 0; i < node.Arguments.ExpressionCount; i++)
                IntrospectiveInvocationMakeReadyArgument(node, inheritedAttributes, i);
        ...
        /// <summary>
        /// Loads the type of the method, and reserves the amount of space neccesary for the arguments 
        /// using an array of [mscorlib]System.Type
        /// </summary>
        /// <param name="numberOfArguments">total number of arguments of method being analized</param>
        /// <param name="memberName">Name of the method</param>
        private void InstrospectiveInvocationLoadType(int numberOfArguments, string memberName) {
            ...
            this.codeGenerator.ldci4(this.indent, numberOfArguments);
            this.codeGenerator.newarr(this.indent, "[mscorlib]System.Type");
        }
        /// <summary>
        /// Generates the code to invoke the method by means of introspection. Besides, it reserve storage as an array
        /// of Objects
        /// </summary>
        /// <param name="node">Ast Node where that contains the method</param>
        /// <param name="obj">argument of the InvocationExpression</param>
        private void IntrospectiveInvocationInvokeMethod(InvocationExpression node, Object obj) {
