...
namespace Parser
{
	...
	///   as for section "A.1.6 Identifers" for determining if an name is indeed a 
	///   VERBATIM_IDENTIFIER. It's contents MUST be kept in sync with the contents of section 
	///   "A.1.7 Keywords" above.
	/// </summary>
	///
	public static Hashtable keywordsTable = new Hashtable();
	...
	public bool IsCombiningCharacter(string s)
	{
		...
		private void initialize()
		{
			...
			literals.Add("namespace", 92);
			literals.Add("type", 147);
			literals.Add("public", 102);
			literals.Add("byte", 60);
			literals.Add("extern", 76);
			literals.Add("uint", 119);
			literals.Add("case", 61);
			literals.Add("new", 93);
			literals.Add("sealed", 107);
			literals.Add("object", 95);
			literals.Add("readonly", 103);
			literals.Add("checked", 64);
			literals.Add("finally", 77);
			literals.Add("lock", 90);
			literals.Add("module", 144);
			literals.Add("unchecked", 121);
			literals.Add("return", 105);
			literals.Add("var", 129);
			literals.Add("abstract", 55);
			literals.Add("null", 94);
			literals.Add("sizeof", 109);
			literals.Add("protected", 101);
			literals.Add("false", 17);
			literals.Add("add", 137);
			literals.Add("ref", 104);
			literals.Add("base", 57);
			literals.Add("default", 18);
			literals.Add("do", 70);
			literals.Add("out", 97);
			literals.Add("params", 99);
			literals.Add("set", 140);
			literals.Add("assembly", 141);
			literals.Add("field", 142);
			literals.Add("catch", 62);
			literals.Add("interface", 87);
			literals.Add("volatile", 127);
			literals.Add("is", 89);
			literals.Add("ulong", 120);
			literals.Add("explicit", 75);
			literals.Add("internal", 88);
			literals.Add("if", 83);
			literals.Add("override", 98);
			literals.Add("double", 71);
			literals.Add("as", 56);
			literals.Add("delegate", 69);
			literals.Add("implicit", 84);
			literals.Add("try", 117);
			literals.Add("remove", 138);
			literals.Add("ushort", 123);
			literals.Add("enum", 73);
			literals.Add("goto", 82);
			literals.Add("int", 86);
			literals.Add("for", 80);
			literals.Add("event", 74);
			literals.Add("char", 63);
			literals.Add("private", 100);
			literals.Add("string", 112);
			literals.Add("class", 65);
			literals.Add("unsafe", 122);
			literals.Add("this", 115);
			literals.Add("static", 111);
			literals.Add("fixed", 78);
			literals.Add("operator", 96);
			literals.Add("using", 124);
			literals.Add("property", 146);
			literals.Add("throw", 116);
			literals.Add("foreach", 81);
			literals.Add("get", 139);
			literals.Add("float", 79);
			literals.Add("const", 66);
			literals.Add("continue", 67);
			literals.Add("bool", 58);
			literals.Add("struct", 113);
			literals.Add("typeof", 118);
			literals.Add("decimal", 68);
			literals.Add("stackalloc", 110);
			literals.Add("method", 143);
			literals.Add("else", 72);
			literals.Add("in", 85);
			literals.Add("void", 126);
			literals.Add("param", 145);
			literals.Add("switch", 114);
			literals.Add("sbyte", 106);
			literals.Add("true", 16);
			literals.Add("long", 91);
			literals.Add("virtual", 125);
			literals.Add("while", 128);
			literals.Add("break", 59);
...
_loop6_breakloop:				;
	...
	protected void mPP_DIRECTIVE(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = PP_DIRECTIVE;
...
_loop136_breakloop:			;
		}    // ( ... )*
		{
			...
			default:
				if ((cached_LA1=='e') && (cached_LA2=='r'))
				{
					match("error");
					_ttype = PP_ERROR;     	
				}
				else if ((cached_LA1=='e') && (cached_LA2=='l'||cached_LA2=='n')) {
					match('e');
					{
						if ((cached_LA1=='l'))
						{
						...
						else if ((cached_LA1=='n')) {
							match("nd");
							{
								if ((cached_LA1=='i'))
								{
									match("if");
									_ttype = PP_COND_ENDIF;
								}
			...
			{
				{
					...
					else if (((cached_LA1=='\\'))&&( IsLetterCharacter(eseq.getText()) )) {
				...
				{    // ( ... )*
					for (;;)
					{
						if ((tokenSet_7_.member(cached_LA1)))
						{
							...
							mCONNECTING_CHARACTER(false);
						}
						else if ((tokenSet_10_.member(cached_LA1))) {
							mCOMBINING_CHARACTER(false);
						}
						else if ((tokenSet_11_.member(cached_LA1))) {
							mFORMATTING_CHARACTER(false);
						}
						else if (((cached_LA1=='\\'))&&( IsIdentifierCharacter(eseq2.getText()) )) {
							mUNICODE_ESCAPE_SEQUENCE(true);
							eseq2 = returnToken_;
						}
						else
	...
	protected void mCOMBINING_CHARACTER(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		if ((tokenSet_18_.member(cached_LA1)))
		{
			mUNICODE_CLASS_Mn(false);
		}
		else if ((tokenSet_19_.member(cached_LA1))) {
	...
	protected void mFORMATTING_CHARACTER(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
	...
	public void mINT_LITERAL(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = INT_LITERAL;
		...
		if ((cached_LA1=='0') && (cached_LA2=='X'||cached_LA2=='x'))
		{
			...
			{ // ( ... )+
				...
				for (;;)
				{
					if ((tokenSet_20_.member(cached_LA1)))
					{
						mHEX_DIGIT(false);
					}
					else
...
_loop25_breakloop:				;
			}    // ( ... )+
			{
				...
				else if ((cached_LA1=='U'||cached_LA1=='u')) {
					{
						if ((cached_LA1=='u'))
						{
							match('u');
...
_loop40_breakloop:								;
					...
					}
					{
						...
						else if ((cached_LA1=='D'||cached_LA1=='d')) {
							{
								if ((cached_LA1=='d'))
								{
									match('d');
								}
								else if ((cached_LA1=='D')) {
									match('D');
								}
								else
								{
						...
						else if ((cached_LA1=='M'||cached_LA1=='m')) {
							{
								if ((cached_LA1=='m'))
								{
									match('m');
								}
								else if ((cached_LA1=='M')) {
									match('M');
								}
								else
								{
...
_loop54_breakloop:								;
				...
				else if ((cached_LA1=='E'||cached_LA1=='e')) {
					{
						if ((cached_LA1=='e'))
						{
							match('e');
...
_loop62_breakloop:						;
				...
				else if ((tokenSet_21_.member(cached_LA1))) {
					{
						if ((cached_LA1=='F'||cached_LA1=='f'))
						{
							{
				...
				else if ((cached_LA1=='L'||cached_LA1=='U'||cached_LA1=='l'||cached_LA1=='u')) {
					{
						if ((cached_LA1=='L'||cached_LA1=='l'))
						{
							{
	...
	public void mCHAR_LITERAL(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		match('\'');
		{
			if ((tokenSet_22_.member(cached_LA1)))
			{
				{
					match(tokenSet_22_);
				}
	...
	protected void mESCAPED_LITERAL(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = ESCAPED_LITERAL;
		
		if ((cached_LA1=='\\') && (tokenSet_23_.member(cached_LA2)))
		{
			match('\\');
			{
				switch ( cached_LA1 )
				...
				case 'x':
				{
					...
					mHEX_DIGIT(false);
					{
						if ((tokenSet_20_.member(cached_LA1)) && (tokenSet_0_.member(cached_LA2)) && (true))
						{
							mHEX_DIGIT(false);
							{
								if ((tokenSet_20_.member(cached_LA1)) && (tokenSet_0_.member(cached_LA2)) && (true))
	...
	public void mSTRING_LITERAL(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		{    // ( ... )*
			for (;;)
			{
				if ((tokenSet_24_.member(cached_LA1)))
				{
					{
						match(tokenSet_24_);
					}
...
_loop84_breakloop:			;
	...
	public void mOPEN_CURLY(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = OPEN_CURLY;
	...
	public void mCLOSE_CURLY(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = CLOSE_CURLY;
	...
	public void mOPEN_BRACK(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = OPEN_BRACK;
	...
	public void mCLOSE_BRACK(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = CLOSE_BRACK;
	...
	public void mOPEN_PAREN(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = OPEN_PAREN;
	...
	public void mCLOSE_PAREN(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = CLOSE_PAREN;
	...
	public void mMOD(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
	...
	public void mBIN_AND(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = BIN_AND;
	...
	public void mBIN_OR(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = BIN_OR;
	...
	public void mBIN_XOR(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = BIN_XOR;
	...
	public void mLOG_NOT(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = LOG_NOT;
	...
	public void mBIN_NOT(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = BIN_NOT;
	...
	public void mDEC(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
	...
	public void mLOG_AND(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = LOG_AND;
	...
	public void mLOG_OR(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = LOG_OR;
	...
	public void mSHIFTL(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = SHIFTL;
	...
	public void mSHIFTR(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = SHIFTR;
	...
	public void mMOD_ASSIGN(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
	...
	public void mBIN_AND_ASSIGN(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = BIN_AND_ASSIGN;
	...
	public void mBIN_OR_ASSIGN(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = BIN_OR_ASSIGN;
	...
	public void mBIN_XOR_ASSIGN(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = BIN_XOR_ASSIGN;
	...
	public void mSHIFTL_ASSIGN(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = SHIFTL_ASSIGN;
	...
	public void mSHIFTR_ASSIGN(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = SHIFTR_ASSIGN;
	...
	public void mDEREF(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = DEREF;
	...
	protected void mUNICODE_CLASS_Cf(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
	...
	private static long[] mk_tokenSet_1_()
	{
		...
		for (int i = 4; i<=7; i++) { data[i]=-1L; }
		data[8]=4503591037435903L;
		data[9]=-65536L;
		data[10]=-432556670460100609L;
		data[11]=70501888360451L;
		data[12]=0L;
		data[13]=288230376151711744L;
		data[14]=-17179879616L;
		data[15]=18014398509449215L;
		for (int i = 16; i<=17; i++) { data[i]=-1L; }
		data[18]=-1021L;
		data[19]=234187180623233023L;
		data[20]=-562949953355777L;
		data[21]=-8547991553L;
		data[22]=255L;
		...
		for (int i = 99; i<=119; i++) { data[i]=0L; }
		...
		data[132]=-2018811855607169916L;
		data[133]=-4294966304L;
		data[134]=15L;
	...
	private static long[] mk_tokenSet_8_()
	{
		...
		data[65]=1023L;
		for (int i = 66; i<=76; i++) { data[i]=0L; }
		data[77]=1123700883587072L;
		for (int i = 78; i<=94; i++) { data[i]=0L; }
		data[95]=4393751543808L;
		data[96]=67043328L;
		for (int i = 97; i<=1019; i++) { data[i]=0L; }
		data[1020]=67043328L;
	...
	private static long[] mk_tokenSet_9_()
	{
		...
		data[129]=1L;
		for (int i = 130; i<=194; i++) { data[i]=0L; }
		data[195]=576460752303423488L;
		for (int i = 196; i<=1015; i++) { data[i]=0L; }
		data[1016]=6755399441055744L;
		data[1017]=57344L;
		for (int i = 1018; i<=1019; i++) { data[i]=0L; }
		data[1020]=-9223372036854775808L;
		data[1021]=137438953472L;
	...
	{
		long[] data = new long[2048];
		for (int i = 0; i<=26; i++) { data[i]=0L; }
		data[27]=536870912L;
		data[28]=32768L;
		for (int i = 29; i<=95; i++) { data[i]=0L; }
		data[96]=16384L;
		for (int i = 97; i<=127; i++) { data[i]=0L; }
		data[128]=136339441905664L;
		data[129]=277141354708992L;
		for (int i = 130; i<=1018; i++) { data[i]=0L; }
		data[1019]=-9223372036854775808L;
		for (int i = 1020; i<=1022; i++) { data[i]=0L; }
		data[1023]=1008806316530991104L;
		for (int i = 1024; i<=2047; i++) { data[i]=0L; }
		return data;
	}
