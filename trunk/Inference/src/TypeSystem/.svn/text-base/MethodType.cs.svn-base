...
namespace TypeSystem {
    ...
    public class MethodType : TypeExpression, IMemberType {
        ...
        //    if ((!this.MemberInfo.Modifiers.Contains(Modifier.Static)) && methodAnalyzed != null &&
        //        methodAnalyzed.MemberInfo.Modifiers.Contains(Modifier.Static) && actualImplicitObject == null) {
        //        ErrorManager.Instance.NotifyError(new InstanceMethodCallFromStaticMethodError(this.FullName, methodAnalyzed.FullName, loc));
        //        return null;
        //    }

        //    // * Is Unification necessary?
        //    if (this.MemberInfo.Class.HasTypeVariables() || this.HasTypeVariables())
        //        // * We infer the return type
        //        return methodCall(actualImplicitObject, this, arguments, methodAnalyzed, activeSortOfUnification, loc);

        //    // * Otherwise...
        //    // Check the argument number
        //    if (arguments.GetLength(0) != this.ParameterListCount) {
        //        ErrorManager.Instance.NotifyError(new ArgumentNumberError(this.MemberInfo.MemberIdentifier, arguments.GetLength(0), loc));
        //        return null;
        //    }
        //    // Check the argument type
        //    for (int i = 0; i < this.ParameterListCount; i++)
        //        arguments[i].Promotion(this.paramList[i], methodAnalyzed, loc);
        ...
        #region EqualsForOverload() NO ANULADA
        /// <summary>
