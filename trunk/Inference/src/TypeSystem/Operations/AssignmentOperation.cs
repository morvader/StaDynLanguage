...
namespace TypeSystem.Operations {
    ...
    public class AssignmentOperation : TypeSystemOperation {
        ...
        /// <summary>
        /// The kind of assignmt to perform. That is, =, +=, -=,... etc
        /// </summary>
       ...
       ///</returns>
        public override object Exec(FieldType leftOperand, object arg) {
            ...
            if (leftOperand.HasTypeVariables() && this.methodAnalyzed != null && ClassType.IsConcreteType(this.actualImplicitObject) == null) {
                ...
                if (found) {
                    ...
                    this.methodAnalyzed.AddConstraint(new FieldTypeAssignmentConstraint(fieldType, this.rightOperand, this.unification));
                    this.methodAnalyzed.ValidTypeExpression = false;
                    return leftOperand.FieldTypeExpression;
                }
            }
            if (!found && leftOperand.FieldTypeExpression != null)
                return leftOperand.FieldTypeExpression.AcceptOperation(new AssignmentOperation(this.rightOperand, this.op, null, this.unification, this.actualImplicitObject, this.location), arg);
