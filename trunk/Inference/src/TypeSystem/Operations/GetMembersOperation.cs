...
namespace TypeSystem.Operations
{
    ...
    public class GetMembersOperation : TypeSystemOperation
    {
        ...
        static BCLClassType intBCLClassType = new BCLClassType("System.Int32", Type.GetType("System.Int32"));
        static BCLClassType charBCLClassType = new BCLClassType("System.Char", Type.GetType("System.Char"));
        static BCLClassType doubleBCLClassType = new BCLClassType("System.Double", Type.GetType("System.Double"));
        static BCLClassType boolBCLClassType = new BCLClassType("System.Boolean", Type.GetType("System.Boolean"));
        ...
        {
           // return emptyAccessModifier;
            return intBCLClassType.AcceptOperation(this, null);
            //return base.Exec(i, arg);
        }
        public override object Exec(BoolType b, object arg)
        {
            //return emptyAccessModifier;
            return boolBCLClassType.AcceptOperation(this, null);
        }

        public override object Exec(DoubleType d, object arg)
        {
            //return emptyAccessModifier;
            return doubleBCLClassType.AcceptOperation(this, null);
        }

        public override object Exec(CharType c, object arg)
        {
            //return emptyAccessModifier;
            return charBCLClassType.AcceptOperation(this, null);
        }

        #region TypeVariable
        public override object Exec(TypeVariable tv, object arg)
        { // this is a likely array
